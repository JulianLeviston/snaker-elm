...
var _JulianLeviston$snaker_elm$Data_Direction$South = {ctor: 'South'};
var _JulianLeviston$snaker_elm$Data_Direction$West = {ctor: 'West'};
var _JulianLeviston$snaker_elm$Data_Direction$East = {ctor: 'East'};
var _JulianLeviston$snaker_elm$Data_Direction$North = {ctor: 'North'};
var _JulianLeviston$snaker_elm$Data_Direction$fromString = function (string) {
	var _p0 = string;
	switch (_p0) {
		case 'north':
			return _elm_lang$core$Maybe$Just(_JulianLeviston$snaker_elm$Data_Direction$North);
		case 'North':
			return _elm_lang$core$Maybe$Just(_JulianLeviston$snaker_elm$Data_Direction$North);
		case 'NORTH':
			return _elm_lang$core$Maybe$Just(_JulianLeviston$snaker_elm$Data_Direction$North);
		case 'east':
			return _elm_lang$core$Maybe$Just(_JulianLeviston$snaker_elm$Data_Direction$East);
		case 'East':
			return _elm_lang$core$Maybe$Just(_JulianLeviston$snaker_elm$Data_Direction$East);
		case 'EAST':
			return _elm_lang$core$Maybe$Just(_JulianLeviston$snaker_elm$Data_Direction$East);
		case 'west':
			return _elm_lang$core$Maybe$Just(_JulianLeviston$snaker_elm$Data_Direction$West);
		case 'West':
			return _elm_lang$core$Maybe$Just(_JulianLeviston$snaker_elm$Data_Direction$West);
		case 'WEST':
			return _elm_lang$core$Maybe$Just(_JulianLeviston$snaker_elm$Data_Direction$West);
		case 'south':
			return _elm_lang$core$Maybe$Just(_JulianLeviston$snaker_elm$Data_Direction$South);
		case 'South':
			return _elm_lang$core$Maybe$Just(_JulianLeviston$snaker_elm$Data_Direction$South);
		case 'SOUTH':
			return _elm_lang$core$Maybe$Just(_JulianLeviston$snaker_elm$Data_Direction$South);
...
var _JulianLeviston$snaker_elm$Data_Direction$keyCodeToMaybeDirection = function (keyCode) {
	var _p1 = keyCode;
	switch (_p1) {
		case 38:
			return _elm_lang$core$Maybe$Just(_JulianLeviston$snaker_elm$Data_Direction$North);
...
var _JulianLeviston$snaker_elm$Data_Position$gridDimensions = {x: 40, y: 30};
var _JulianLeviston$snaker_elm$Data_Position$randomPosition = A3(
	_elm_lang$core$Random$map2,
	F2(
		function (x, y) {
			return {x: x, y: y};
		}),
	A2(_elm_lang$core$Random$int, 1, _JulianLeviston$snaker_elm$Data_Position$gridDimensions.x),
	A2(_elm_lang$core$Random$int, 1, _JulianLeviston$snaker_elm$Data_Position$gridDimensions.y));
var _JulianLeviston$snaker_elm$Data_Position$wrapVal = F3(
	function (minVal, maxVal, val) {
		return _elm_lang$core$Native_Utils.eq(
			A2(_elm_lang$core$Basics$max, val, maxVal + 1),
			val) ? minVal : (_elm_lang$core$Native_Utils.eq(
			A2(_elm_lang$core$Basics$min, val, minVal - 1),
			val) ? maxVal : val);
	});
var _JulianLeviston$snaker_elm$Data_Position$wrapPosition = function (_p0) {
	var _p1 = _p0;
	var newY = A3(_JulianLeviston$snaker_elm$Data_Position$wrapVal, 1, _JulianLeviston$snaker_elm$Data_Position$gridDimensions.y + 0, _p1.y);
	var newX = A3(_JulianLeviston$snaker_elm$Data_Position$wrapVal, 1, _JulianLeviston$snaker_elm$Data_Position$gridDimensions.x + 0, _p1.x);
	return {x: newX, y: newY};
};
var _JulianLeviston$snaker_elm$Data_Position$nextPositionInDirection = F2(
	function (direction, _p2) {
		var _p3 = _p2;
		var _p6 = _p3.y;
		var _p5 = _p3.x;
		return _JulianLeviston$snaker_elm$Data_Position$wrapPosition(
			function () {
				var _p4 = direction;
				switch (_p4.ctor) {
					case 'North':
						return {x: _p5, y: _p6 + 1};
					case 'East':
						return {x: _p5 + 1, y: _p6};
					case 'West':
						return {x: _p5 - 1, y: _p6};
					default:
						return {x: _p5, y: _p6 - 1};
...
var _JulianLeviston$snaker_elm$Data_Position$Position = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _JulianLeviston$snaker_elm$Data_Position$Dimensions = F2(
	function (a, b) {
		return {x: a, y: b};
	});

var _JulianLeviston$snaker_elm$Data_Apple$eatApplesAt = F2(
	function (removeAtPosition, apples) {
		return A2(
			_elm_lang$core$List$filter,
			function (_p0) {
				var _p1 = _p0;
				return !_elm_lang$core$Native_Utils.eq(_p1.position, removeAtPosition);
			},
			apples);
	});
var _JulianLeviston$snaker_elm$Data_Apple$expireApples = function (time) {
...
var _JulianLeviston$snaker_elm$Data_Player$setColour = F2(
	function (colour, player) {
...
var _JulianLeviston$snaker_elm$Data_Player$setId = F2(
	function (id, player) {
		return _elm_lang$core$Native_Utils.update(
			player,
			{playerId: id});
...
var _JulianLeviston$snaker_elm$Data_Player$playerDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_JulianLeviston$snaker_elm$Data_Player$initWithIdNameAndColour,
	A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'colour', _elm_lang$core$Json_Decode$string));
var _JulianLeviston$snaker_elm$Data_Player$playerDictDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	function (dict) {
	...
	_elm_lang$core$Json_Decode$dict(_JulianLeviston$snaker_elm$Data_Player$playerDecoder));
		...
		var changedDirection = function () {
			...
			do {
				if (_p0.ctor === '_Tuple2') {
					switch (_p0._0.ctor) {
						case 'North':
							if (_p0._1.ctor === 'South') {
								return _JulianLeviston$snaker_elm$Data_Direction$North;
							} else {
								break _v0_4;
							}
						case 'South':
							if (_p0._1.ctor === 'North') {
								return _JulianLeviston$snaker_elm$Data_Direction$South;
							} else {
								break _v0_4;
							}
						case 'East':
							if (_p0._1.ctor === 'West') {
								return _JulianLeviston$snaker_elm$Data_Direction$East;
							} else {
								break _v0_4;
							}
						default:
							if (_p0._1.ctor === 'East') {
								return _JulianLeviston$snaker_elm$Data_Direction$West;
							} else {
								break _v0_4;
							}
					}
...
var _JulianLeviston$snaker_elm$Data_Snake$eatApples = F2(
	function (_p1, apples) {
		var _p2 = _p1;
		var _p3 = _p2.body;
		if (_p3.ctor === '[]') {
			...
			return A2(_JulianLeviston$snaker_elm$Data_Apple$eatApplesAt, _p3._0, apples);
		}
	});
var _JulianLeviston$snaker_elm$Data_Snake$growSnake = F2(
	function (apples, _p4) {
		var _p5 = _p4;
		var _p9 = _p5;
		var _p8 = _p5.body;
		...
		if (_p6.ctor === '[]') {
			...
			return A2(
				...
				A2(
					...
					apples)) ? _elm_lang$core$Native_Utils.update(
				_p9,
				{
					body: {
						ctor: '::',
						_0: A2(_JulianLeviston$snaker_elm$Data_Position$nextPositionInDirection, _p5.direction, _p7),
						_1: _p8
					}
				}) : _p9;
		}
	});
var _JulianLeviston$snaker_elm$Data_Snake$moveSnake = function (_p10) {
	var _p11 = _p10;
	var _p14 = _p11;
	var _p13 = _p11.body;
	var _p12 = _p13;
	if (_p12.ctor === '[]') {
		...
		var newHead = A2(_JulianLeviston$snaker_elm$Data_Position$nextPositionInDirection, _p11.direction, _p12._0);
		var newBody = {
			ctor: '::',
			_0: newHead,
			_1: A2(
				_elm_lang$core$List$take,
				_elm_lang$core$List$length(_p13) - 1,
				_p13)
		};
		return _elm_lang$core$Native_Utils.update(
			_p14,
...
var _JulianLeviston$snaker_elm$Data_Snake$setPlayer = F2(
	function (player, snake) {
		return _elm_lang$core$Native_Utils.update(
			snake,
			{player: player});
	});
var _JulianLeviston$snaker_elm$Data_Snake$setId = F2(
	function (id, snake) {
		var player = A2(_JulianLeviston$snaker_elm$Data_Player$setId, id, _JulianLeviston$snaker_elm$Data_Player$init);
		return A2(_JulianLeviston$snaker_elm$Data_Snake$setPlayer, player, snake);
	});
var _JulianLeviston$snaker_elm$Data_Snake$initialSnake = function () {
	var y = (_JulianLeviston$snaker_elm$Data_Position$gridDimensions.y / 2) | 0;
	var x = (_JulianLeviston$snaker_elm$Data_Position$gridDimensions.x / 2) | 0;
	var initialSegment = {x: x, y: y};
	var tailDirection = _JulianLeviston$snaker_elm$Data_Direction$West;
	var subsequentSegment = A2(_JulianLeviston$snaker_elm$Data_Position$nextPositionInDirection, tailDirection, initialSegment);
...
var _JulianLeviston$snaker_elm$Data_Board$progressBoard = F3(
	function (nextTime, playerId, _p6) {
		var _p7 = _p6;
		var _p12 = _p7.snakes;
		var _p11 = _p7.apples;
		var _p8 = function () {
			...
			if (_p9.ctor === 'Nothing') {
				...
				var _p10 = A3(_JulianLeviston$snaker_elm$Data_Board$nextSnakeAndApples, nextTime, _p9._0, _p11);
				var newSnake = _p10._0;
				var newApples = _p10._1;
				return {
					ctor: '_Tuple2',
		...
		var nextSnakes = _p8._0;
		var nextApples = _p8._1;
		return _elm_lang$core$Native_Utils.update(
			_p7,
			{time: nextTime, snakes: nextSnakes, apples: nextApples});
	});
var _JulianLeviston$snaker_elm$Data_Board$directionOfPlayer = F2(
	function (playerId, _p13) {
		var _p14 = _p13;
		return A2(
			_elm_lang$core$Maybe$map,
			_JulianLeviston$snaker_elm$Data_Snake$direction,
			A2(_elm_lang$core$Dict$get, playerId, _p14.snakes));
	});
var _JulianLeviston$snaker_elm$Data_Board$currentPlayerId = function (_) {
	return _.currentPlayerId;
};
...
var _JulianLeviston$snaker_elm$Data_Board$tileTypeFromPositionTileTypePairs = F2(
	function (renderables, tilePosition) {
		return A2(
			...
			_JulianLeviston$snaker_elm$Data_Board$EmptyTile,
			A2(
				_elm_lang$core$Dict$get,
				{ctor: '_Tuple2', _0: tilePosition.x, _1: tilePosition.y},
				renderables));
	});
var _JulianLeviston$snaker_elm$Data_Board$ChangeDirectionOfPlayer = F2(
	function (a, b) {
		return {ctor: 'ChangeDirectionOfPlayer', _0: a, _1: b};
	});
var _JulianLeviston$snaker_elm$Data_Board$toChangePlayerDirectionMsg = _JulianLeviston$snaker_elm$Data_Board$ChangeDirectionOfPlayer;
var _JulianLeviston$snaker_elm$Data_Board$RemovePlayer = function (a) {
	return {ctor: 'RemovePlayer', _0: a};
};
var _JulianLeviston$snaker_elm$Data_Board$toRemovePlayerMsg = _JulianLeviston$snaker_elm$Data_Board$RemovePlayer;
var _JulianLeviston$snaker_elm$Data_Board$SetupNewPlayer = function (a) {
	return {ctor: 'SetupNewPlayer', _0: a};
};
var _JulianLeviston$snaker_elm$Data_Board$toSetupNewPlayerMsg = _JulianLeviston$snaker_elm$Data_Board$SetupNewPlayer;
var _JulianLeviston$snaker_elm$Data_Board$SetupPlayers = function (a) {
	return {ctor: 'SetupPlayers', _0: a};
};
var _JulianLeviston$snaker_elm$Data_Board$toSetupPlayersMsg = _JulianLeviston$snaker_elm$Data_Board$SetupPlayers;
var _JulianLeviston$snaker_elm$Data_Board$SetCurrentPlayer = function (a) {
	return {ctor: 'SetCurrentPlayer', _0: a};
};
var _JulianLeviston$snaker_elm$Data_Board$toSetCurrentPlayerMsg = _JulianLeviston$snaker_elm$Data_Board$SetCurrentPlayer;
var _JulianLeviston$snaker_elm$Data_Board$AddApple = function (a) {
	return {ctor: 'AddApple', _0: a};
};
var _JulianLeviston$snaker_elm$Data_Board$update = F2(
	function (msg, _p15) {
		var _p16 = _p15;
		var _p22 = _p16.snakes;
		var _p21 = _p16;
		var _p17 = msg;
		switch (_p17.ctor) {
			case 'Tick':
				var _p18 = _p17._0;
				var playerIds = _elm_lang$core$Dict$keys(_p22);
				var newBoard = A3(
					_elm_lang$core$List$foldl,
					_JulianLeviston$snaker_elm$Data_Board$progressBoard(_p18),
					_p21,
					playerIds);
				return {
					ctor: '_Tuple2',
					...
					_1: _elm_lang$core$Native_Utils.eq(
						...
						_JulianLeviston$snaker_elm$Data_Apple$randomApple(_p18)) : _elm_lang$core$Platform_Cmd$none
				};
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						_p21,
						{
							snakes: A3(
								_elm_lang$core$Dict$update,
								_p16.currentPlayerId,
								_elm_lang$core$Maybe$map(
									_JulianLeviston$snaker_elm$Data_Snake$changeSnakeDirection(_p17._0)),
								_p22)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ChangeDirectionOfPlayer':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						_p21,
						{
							snakes: A3(
								...
								_p17._0,
								_elm_lang$core$Maybe$map(
									_JulianLeviston$snaker_elm$Data_Snake$changeSnakeDirection(_p17._1)),
								_p22)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'AddApple':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						_p21,
						{
							apples: {ctor: '::', _0: _p17._0, _1: _p21.apples}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SetCurrentPlayer':
				var _p19 = _p17._0;
				var playerSnake = A2(_JulianLeviston$snaker_elm$Data_Snake$setPlayer, _p19, _JulianLeviston$snaker_elm$Data_Snake$initialSnake);
				var playerId = _JulianLeviston$snaker_elm$Data_Player$id(_p19);
				var newSnakes = A3(_elm_lang$core$Dict$insert, playerId, playerSnake, _p21.snakes);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						_p21,
						{currentPlayerId: playerId, snakes: newSnakes}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SetupPlayers':
				var newSnakes = A2(
					...
					F2(
						function (_p20, player) {
							return A2(_JulianLeviston$snaker_elm$Data_Snake$setPlayer, player, _JulianLeviston$snaker_elm$Data_Snake$initialSnake);
						}),
					_p17._0);
				return {
					ctor: '_Tuple2',
			...
			case 'SetupNewPlayer':
				var newSnake = A2(_JulianLeviston$snaker_elm$Data_Snake$setPlayer, _p17._0, _JulianLeviston$snaker_elm$Data_Snake$initialSnake);
				var newSnakes = A3(
					_elm_lang$core$Dict$insert,
					_JulianLeviston$snaker_elm$Data_Snake$id(newSnake),
					newSnake,
					_p22);
				return {
					ctor: '_Tuple2',
			...
			default:
				var newSnakes = A2(_elm_lang$core$Dict$remove, _p17._0.playerId, _p22);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						_p21,
...
var _JulianLeviston$snaker_elm$Data_Board$ChangeDirection = function (a) {
	return {ctor: 'ChangeDirection', _0: a};
};
var _JulianLeviston$snaker_elm$Data_Board$toChangeDirectionMsg = _JulianLeviston$snaker_elm$Data_Board$ChangeDirection;
var _JulianLeviston$snaker_elm$Data_Board$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _JulianLeviston$snaker_elm$Data_Board$tickBoardMsg = _JulianLeviston$snaker_elm$Data_Board$Tick;

var _JulianLeviston$snaker_elm$Board_Html$tileSideLength = 20;
var _JulianLeviston$snaker_elm$Board_Html$tileLengthPixels = A2(
	_elm_lang$core$Basics_ops['++'],
	_elm_lang$core$Basics$toString(_JulianLeviston$snaker_elm$Board_Html$tileSideLength),
	'px');
var _JulianLeviston$snaker_elm$Board_Html$mkTile = F2(
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'width', _1: _JulianLeviston$snaker_elm$Board_Html$tileLengthPixels},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'height', _1: _JulianLeviston$snaker_elm$Board_Html$tileLengthPixels},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'border', _1: '1px solid #EEEEEE'},
								_1: {
									ctor: '::',
...
var _JulianLeviston$snaker_elm$Board_Html$mkGrid = function (_p1) {
	...
	var appleTilePositions = A2(
		_elm_lang$core$List$map,
		function (apple) {
			return {ctor: '_Tuple2', _0: apple.position, _1: _JulianLeviston$snaker_elm$Data_Board$AppleTile};
		},
		_p2.apples);
	var positionTilePairs = _elm_lang$core$List$concat(
		{
			ctor: '::',
			_0: appleTilePositions,
			_1: {
				ctor: '::',
				_0: snakeTilePositions,
				_1: {ctor: '[]'}
			}
		});
	var renderables = _elm_lang$core$Dict$fromList(
		A2(_elm_lang$core$List$map, _JulianLeviston$snaker_elm$Data_Board$convertToKVPair, positionTilePairs));
	var tileTypeForPosn = _JulianLeviston$snaker_elm$Data_Board$tileTypeFromPositionTileTypePairs(renderables);
	var tileTypeFor = F2(
		function (x, y) {
			return tileTypeForPosn(
				{x: x, y: y});
		});
	var dim = _JulianLeviston$snaker_elm$Data_Position$gridDimensions;
	var row = function (y) {
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_0: {
							...
							_1: A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(_JulianLeviston$snaker_elm$Board_Html$tileSideLength * dim.x),
								'px')
						},
						_1: {ctor: '[]'}
					}),
			...
			A2(
				...
				function (x) {
					return A2(
						_JulianLeviston$snaker_elm$Board_Html$mkTile,
						A2(tileTypeFor, x, y),
						{ctor: '[]'});
				},
				A2(_elm_lang$core$List$range, 1, dim.x)));
	};
	var grid = A2(
		_elm_lang$core$List$map,
		row,
		_elm_lang$core$List$reverse(
			A2(_elm_lang$core$List$range, 1, dim.y)));
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		grid);
};
var _JulianLeviston$snaker_elm$Board_Html$view = function (board) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _JulianLeviston$snaker_elm$Board_Html$mkGrid(board),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					A2(
						...
						_elm_lang$core$Basics$toString(
							_JulianLeviston$snaker_elm$Data_Board$score(board)))),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(' '),
					_1: {
						...
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(
								_JulianLeviston$snaker_elm$Data_Board$currentPlayerId(board))),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _JulianLeviston$snaker_elm$Main$playerChangedDirectionDecoder = A3(
	...
	A2(
		...
		A2(
			_elm_lang$core$Json_Decode$andThen,
			function (string) {
				var _p0 = _JulianLeviston$snaker_elm$Data_Direction$fromString(string);
				if (_p0.ctor === 'Just') {
					return _elm_lang$core$Json_Decode$succeed(_p0._0);
				} else {
					return _elm_lang$core$Json_Decode$fail('Direction not supplied');
				}
			},
			_elm_lang$core$Json_Decode$string)));
var _JulianLeviston$snaker_elm$Main$objectWithPlayerDecoder = A2(_elm_lang$core$Json_Decode$field, 'player', _JulianLeviston$snaker_elm$Data_Player$playerDecoder);
var _JulianLeviston$snaker_elm$Main$joinGameDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	F2(
		function (v0, v1) {
			return {ctor: '_Tuple2', _0: v0, _1: v1};
		}),
	A2(_elm_lang$core$Json_Decode$field, 'player', _JulianLeviston$snaker_elm$Data_Player$playerDecoder),
	A2(_elm_lang$core$Json_Decode$field, 'players', _JulianLeviston$snaker_elm$Data_Player$playerDictDecoder));
var _JulianLeviston$snaker_elm$Main$Model = F2(
	function (a, b) {
...
var _JulianLeviston$snaker_elm$Main$Noop = {ctor: 'Noop'};
var _JulianLeviston$snaker_elm$Main$DispatchServerMsg = F2(
	function (a, b) {
		return {ctor: 'DispatchServerMsg', _0: a, _1: b};
	});
var _JulianLeviston$snaker_elm$Main$PhoenixMsg = function (a) {
...
var _JulianLeviston$snaker_elm$Main$init = function () {
	...
	var initialSocket = A4(
		...
		A4(
			...
			'player:leave',
			'game:snake',
			_JulianLeviston$snaker_elm$Main$DispatchServerMsg(_JulianLeviston$snaker_elm$Main$PlayerLeft),
			A4(
				_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
				'player:join',
				'game:snake',
				_JulianLeviston$snaker_elm$Main$DispatchServerMsg(_JulianLeviston$snaker_elm$Main$NewPlayerJoined),
				A4(
					_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
					'join',
					'game:snake',
	...
	return {
		ctor: '_Tuple2',
		_0: {board: _JulianLeviston$snaker_elm$Data_Board$init, phxSocket: phxSocket},
		_1: A2(_elm_lang$core$Platform_Cmd$map, _JulianLeviston$snaker_elm$Main$PhoenixMsg, cmd)
	};
}();
var _JulianLeviston$snaker_elm$Main$updateToServer = F2(
	function (msg, model) {
		var _p2 = msg;
		if (_p2.ctor === 'SendChangeDirection') {
			...
			var _p3 = maybeCurrentDirection;
			if (_p3.ctor === 'Nothing') {
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			} else {
				var stringDirection = _elm_lang$core$Basics$toString(_p3._0);
				var payload = _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'player_id',
							_1: _elm_lang$core$Json_Encode$int(currentPlayerId)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'direction',
								_1: _elm_lang$core$Json_Encode$string(stringDirection)
							},
							_1: {ctor: '[]'}
						}
					});
...
var _JulianLeviston$snaker_elm$Main$BoardMsg = function (a) {
	return {ctor: 'BoardMsg', _0: a};
};
var _JulianLeviston$snaker_elm$Main$updateFromServer = F3(
	function (msg, raw, model) {
		var _p5 = msg;
		switch (_p5.ctor) {
			case 'JoinGame':
				var _p6 = A2(_elm_lang$core$Json_Decode$decodeValue, _JulianLeviston$snaker_elm$Main$joinGameDecoder, raw);
				if (_p6.ctor === 'Ok') {
					var _p7 = A2(
						_JulianLeviston$snaker_elm$Data_Board$update,
						_JulianLeviston$snaker_elm$Data_Board$toSetCurrentPlayerMsg(_p6._0._0),
						model.board);
					var newBoard1 = _p7._0;
					var boardCmd1 = _p7._1;
					var newCmd1 = A2(_elm_lang$core$Platform_Cmd$map, _JulianLeviston$snaker_elm$Main$BoardMsg, boardCmd1);
					var _p8 = A2(
						_JulianLeviston$snaker_elm$Data_Board$update,
						_JulianLeviston$snaker_elm$Data_Board$toSetupPlayersMsg(_p6._0._1),
						newBoard1);
					var newBoard2 = _p8._0;
					var boardCmd2 = _p8._1;
					var newCmd2 = A2(_elm_lang$core$Platform_Cmd$map, _JulianLeviston$snaker_elm$Main$BoardMsg, boardCmd2);
			...
			case 'NewPlayerJoined':
				var _p9 = A2(_elm_lang$core$Json_Decode$decodeValue, _JulianLeviston$snaker_elm$Main$objectWithPlayerDecoder, raw);
				if (_p9.ctor === 'Ok') {
					var _p10 = A2(
						_JulianLeviston$snaker_elm$Data_Board$update,
						_JulianLeviston$snaker_elm$Data_Board$toSetupNewPlayerMsg(_p9._0),
						model.board);
					var newBoard = _p10._0;
					var boardCmd = _p10._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{board: newBoard}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _JulianLeviston$snaker_elm$Main$BoardMsg, boardCmd)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'PlayerLeft':
				var _p11 = A2(_elm_lang$core$Json_Decode$decodeValue, _JulianLeviston$snaker_elm$Main$objectWithPlayerDecoder, raw);
				if (_p11.ctor === 'Ok') {
					var _p12 = A2(
						_JulianLeviston$snaker_elm$Data_Board$update,
						_JulianLeviston$snaker_elm$Data_Board$toRemovePlayerMsg(_p11._0),
						model.board);
					var newBoard = _p12._0;
					var boardCmd = _p12._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
			...
			case 'PlayerChangedDirection':
				var _p13 = A2(_elm_lang$core$Json_Decode$decodeValue, _JulianLeviston$snaker_elm$Main$playerChangedDirectionDecoder, raw);
				if (_p13.ctor === 'Ok') {
					var _p14 = A2(
						_JulianLeviston$snaker_elm$Data_Board$update,
						A2(_JulianLeviston$snaker_elm$Data_Board$toChangePlayerDirectionMsg, _p13._0._0, _p13._0._1),
						model.board);
					var newBoard = _p14._0;
					var boardCmd = _p14._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
...
var _JulianLeviston$snaker_elm$Main$update = F2(
	function (msg, model) {
		...
		switch (_p15.ctor) {
			case 'BoardMsg':
				var _p19 = _p15._0;
				var _p16 = A2(_JulianLeviston$snaker_elm$Data_Board$update, _p19, model.board);
				var newBoard = _p16._0;
				var boardCmds = _p16._1;
				var updatedModel = _elm_lang$core$Native_Utils.update(
					model,
					{board: newBoard});
				var _p17 = function () {
					var _p18 = _p19;
					if (_p18.ctor === 'ChangeDirection') {
						return A2(_JulianLeviston$snaker_elm$Main$updateToServer, _JulianLeviston$snaker_elm$Main$SendChangeDirection, updatedModel);
					} else {
				...
				return {
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: A2(_elm_lang$core$Platform_Cmd$map, _JulianLeviston$snaker_elm$Main$BoardMsg, boardCmds),
							_1: {
								ctor: '::',
								_0: newCmd,
								_1: {ctor: '[]'}
			...
			case 'PhoenixMsg':
				var _p20 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$update, _p15._0, model.phxSocket);
			...
			case 'DispatchServerMsg':
				return A3(_JulianLeviston$snaker_elm$Main$updateFromServer, _p15._0, _p15._1, model);
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _JulianLeviston$snaker_elm$Main$tickBoardSubscription = A2(
	...
	function (_p21) {
		return _JulianLeviston$snaker_elm$Main$BoardMsg(
			_JulianLeviston$snaker_elm$Data_Board$tickBoardMsg(_p21));
	});
var _JulianLeviston$snaker_elm$Main$keyCodeToChangeDirectionMsg = function (keyCode) {
	...
	var _p22 = maybeDirection;
	if (_p22.ctor === 'Nothing') {
		return _JulianLeviston$snaker_elm$Main$Noop;
	} else {
		return _JulianLeviston$snaker_elm$Main$BoardMsg(
			_JulianLeviston$snaker_elm$Data_Board$toChangeDirectionMsg(_p22._0));
	}
};
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.phxSocket, _JulianLeviston$snaker_elm$Main$PhoenixMsg),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _JulianLeviston$snaker_elm$Main$view = function (_p23) {
	var _p24 = _p23;
	return A2(
		_elm_lang$html$Html$map,
		_JulianLeviston$snaker_elm$Main$BoardMsg,
		_JulianLeviston$snaker_elm$Board_Html$view(_p24.board));
};
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _JulianLeviston$snaker_elm$Main$main !== 'undefined') {
    _JulianLeviston$snaker_elm$Main$main(Elm['Main'], 'Main', undefined);
}
